...
class Category(models.Model):
    parent = models.ForeignKey('self', verbose_name='parent', blank=True, on_delete=models.CASCADE)
...
class File(models.Model):
    ...
    product = models.ForeignKey('Product', verbose_name='products', related_name='files', on_delete=models.CASCADE)
    title = models.CharField('title', max_length=50)
